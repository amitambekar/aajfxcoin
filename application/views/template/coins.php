                ...
                <div class="card">
                    <div class="header bg-red">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                <button type="button" class="btn btn-default waves-effect" ng-click="buy_coin_modal();">BUY COIN</button>
                            </li>
                        </ul>
                    </div>
                    <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td><?= $row1['amount']; ?></td>
                                      <td><?= ($row1['user_coins_status'] == 'accepted')? $row1['coins']*$coin_price : '-'; ?></td>
