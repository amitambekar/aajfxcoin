      ...
      <div class="attorny-sec  first-class">
        <div class="container">
          ...
          <div class="ques-1">
            ...
            </br>a)  Loyality (Monthly Income)</br>b)  Direct Sales Income</p>
          </div>

          <div class="ques-1">
            <h4><span>Q4.</span> I have registered myself for a free package but I have not paid anything yet. When do I have to pay in order not to lose my position ? </h4>
          ...
          <div class="ques-1">
            <h4><span>Q5.</span> What is kyc ? </h4>
