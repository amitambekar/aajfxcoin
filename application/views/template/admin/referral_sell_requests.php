                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    <?php 
                                    $result=getReferralIncome(0,array('referral_income.status'=>'Debit Request'));
                                    foreach ($result as $row ) { 
                                        ?>
                                        <tr id="row-id-<?php echo $row['referral_income_id']; ?>">
                                            <td username-row-id-<?php echo $row['referral_income_id']; ?>="<?= $row['username'];?>" coins-row-id-<?php echo $row['referral_income_id']; ?>="<?= $row['coins'];?>" coin_price-row-id-<?php echo $row['referral_income_id']; ?>="<?= $row['coin_price'];?>" payment_details-row-id-<?php echo $row['referral_income_id']; ?>="<?= $row['payment_details'];?>" payment_type-row-id-<?php echo $row['referral_income_id']; ?>="<?= $row['payment_type'];?>"><?= $row['username'];?></td>
                                            <td><?= $row['coins'];?></td>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="largeModalLabel">Sell request for referral income</h4>
            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary waves-effect" ng-click="sell_request_referral_coins()">Submit</button>
