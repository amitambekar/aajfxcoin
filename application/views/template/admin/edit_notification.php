                ...
                <div class="card">
                    ...
                    <div class="body">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <textarea id="wysiwyg" class="form-control" placeholder="Enter notification ..." rows="10" ng-model="notification" ng-init="notification='<?= $notification_data['notification']; ?>'"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input type="button" class="btn btn-primary waves-effect" value="Submit" ng-click="edit_notification();"/>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php foreach ($list as $row ) { ?>
                                    <tr id="notification-id-<?= $row['notification_id']; ?>">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-primary waves-effect" ng-click="deleteNotification(<?= $row['notification_id']; ?>)">Delete</button>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
