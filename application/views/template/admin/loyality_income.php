                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                <?php $details=loyality_income_details();?>
                                <?php foreach ($details as $row ) { 
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-danger waves-effect" ng-click="release_payment_modal(<?= $row['userid'];?>,'loyality_income')">Release Payment</button>
                                            <a class="btn btn-primary waves-effect" href="<?= site_url(); ?>admin_user_payment_details/view/loyality_income/<?= $row['userid']; ?>" target="__blank__">View Details</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-link waves-effect" ng-click="release_payment('loyality_income')">SAVE CHANGES</button>
