...
<body class="login-page" ng-app="MyApp" ng-controller="MyController" style="background-color:#76889e;">
    <div class="login-box">
        <div class="logo">
    ...
    <script src="http://localhost/projects/metronic_v3.6/metronic_v3.6/theme/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
<script>
