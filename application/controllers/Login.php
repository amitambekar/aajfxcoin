...
class Login extends CI_Controller {
	...
	{
		$this->load->view('template/forgot_password');
	}
	...
	public function forgot_password_change_password()
	{
		...
		$this->load->view('template/forgot_password_change_password',$data);
	}
		...
		if($this->input->post())
		{
			...
			if(count($error_array) == 0 )
			{
				...
				if(is_array($result))
				{
					...
					$email_data['html'] = $this->load->view('template/email_templates/forgot_password',$template_data,true);;
					$email_data['to'] = $email;
					//dump($email_data);
